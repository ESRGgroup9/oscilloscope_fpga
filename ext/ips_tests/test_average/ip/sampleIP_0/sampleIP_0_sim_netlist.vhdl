...
-- Date        : Wed Jun 15 18:43:49 2022
-- Host        : fernandes420 running 64-bit Ubuntu 20.04.4 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/fernandes/code/oscilloscope_fpga/ext/ips_tests/test_average/test_average.srcs/sources_1/ip/sampleIP_0/sampleIP_0_sim_netlist.vhdl
-- Design      : sampleIP_0
...
entity sampleIP_0_sampleIP is
  ...
  attribute ORIG_REF_NAME of sampleIP_0_sampleIP : entity is "sampleIP";
end sampleIP_0_sampleIP;

architecture STRUCTURE of sampleIP_0_sampleIP is
  ...
  signal \sampled_val[16]_i_3_n_0\ : STD_LOGIC;
  signal \sampled_val[16]_i_4_n_0\ : STD_LOGIC;
  signal \sampled_val[16]_i_5_n_0\ : STD_LOGIC;
  signal \sampled_val[16]_i_6_n_0\ : STD_LOGIC;
...
\sampled_val[16]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\sampled_val[16]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
      I0 => \sampled_val[16]_i_3_n_0\,
      I1 => \sampled_val[16]_i_4_n_0\,
      I2 => \sampled_val[16]_i_5_n_0\,
      I3 => \sampled_val[16]_i_6_n_0\,
      O => counter_1k
    );
\sampled_val[16]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => counter_reg(7),
      I3 => counter_reg(5),
      O => \sampled_val[16]_i_3_n_0\
    );
\sampled_val[16]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
      ...
      I2 => counter_reg(11),
      I3 => counter_reg(10),
      O => \sampled_val[16]_i_4_n_0\
    );
\sampled_val[16]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
      ...
      I2 => counter_reg(14),
      I3 => counter_reg(15),
      O => \sampled_val[16]_i_5_n_0\
    );
\sampled_val[16]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\sampled_val_reg[16]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => counter_1k,
      D => val(16),
...
entity sampleIP_0 is
  ...
  attribute NotValidForBitStream of sampleIP_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of sampleIP_0 : entity is "sampleIP_0,sampleIP,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of sampleIP_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of sampleIP_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of sampleIP_0 : entity is "sampleIP,Vivado 2019.2";
end sampleIP_0;

architecture STRUCTURE of sampleIP_0 is
...
begin
inst: entity work.sampleIP_0_sampleIP
     port map (
      clk => clk,
      rstn => rstn,
      sample => sample,
      sampled_val(16 downto 0) => sampled_val(16 downto 0),
      val(16 downto 0) => val(16 downto 0)
    );
end STRUCTURE;
