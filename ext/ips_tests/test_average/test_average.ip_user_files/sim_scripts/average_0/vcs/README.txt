...
#
# Generated by export_simulation on Wed Jun 15 10:30:57 WEST 2022
#
################################################################################
...
'-reset_run' switch to the './average_0.sh' script.

./average_0.sh -reset_run
...
./average_0.sh -noclean_files

For more information on the script, please type './average_0.sh -help'.
