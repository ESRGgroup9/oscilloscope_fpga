...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins AXIM_read_xadc_0/MAXI_ADC]
	connect_bd_net [get_bd_pins AXIM_read_xadc_0/maxi_adc_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AXIM_read_xadc_0/maxi_adc_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins AXIM_read_xadc_0/maxi_adc_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins AXIM_read_xadc_0/maxi_adc_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins AXIM_read_xadc_0/maxi_adc_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]
	...
	set_property range 16K [get_bd_addr_segs {AXIM_read_xadc_0/MAXI_ADC/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_MAXI_ADC_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells AXIM_read_xadc_0]

	# Copy all address to AXIM_read_xadc_v1_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/AXIM_read_xadc_v1_include.tcl"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/AXIM_read_xadc_v1_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AXIM_read_xadc_v1_hw_${i}"
