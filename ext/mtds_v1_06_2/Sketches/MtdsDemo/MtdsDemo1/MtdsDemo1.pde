...
/*                                                                              */
/*  WARNING: This demo is not compatible with the Arduino Uno because it is     */
/*           too large to fit in the onboard memory. All other MTDS and MyDisp  */
/*           examples should work fine because they are smaller. If you want to */
/*           make this demo work with the Uno, you should comment out some of   */
/*           test functions to make the program smaller.                        */
/*                                                                              */
/********************************************************************************/
/*  Revision History:                                                           */
/*                                                                              */
/*  2016/09/28(GeneApperson): Adapted from an earlier test program.             */
/*  2017/11/22(SamBobrowicz): Add note about Arduino Uno                        */
/*                                                                              */
/********************************************************************************/
...
void MtdsTest1() {
  ...
  */
  ...
  if (clrS != clrT) {
    Serial.print("Set/Get FG Color error: set = ");
    Serial.print(clrWhite, HEX);
    Serial.print(" get = ");
    Serial.print( clrS, HEX);
    Serial.println();
  }
  ...
  clrT = mtds.GetNearestColor(clrWhite);
  if (clrS != clrT) {
    Serial.print("Set/Get BG Color error: set = ");
    Serial.print(clrWhite, HEX);
    Serial.print(" get = ");
    Serial.print( clrS, HEX);
    Serial.println();
  ...
  if ((pntS.xco != pntT.xco) || (pntS.yco != pntT.yco)) {
    Serial.println("MoveTo/GetCurPos error");
  }
  ...
  */
  ...
  if ((pntT.xco != 120) || (pntT.yco != 30)) {
    Serial.println("MoveTo/Line error");
  }
...
void MtdsTest10() {
  ...
  */
  ...
  if (hbmpTest == 0) {
    Serial.println("MtdsTest10: CreateBitmap failed");
  }
...
void MtdsTest11() {
  ...
  */
  hbmpTest = mtds.CreateBitmap(40, 40, 16);
  if (hbmpTest == 0) {
    Serial.println("MtdsTest11: CreateBitmap failed");
  }
  mtds.SetDrawingSurface(hdsTest, hbmpTest);
...
void MtdsTest12() {
  ...
  */
  ...
  hbmpTest = mtds.CreateBitmap(40, 40, 16);
  if (hbmpTest == 0) {
    Serial.println("MtdsTest12: CreateBitmap failed");
  }
  mtds.SetDrawingSurface(hdsTest, hbmpTest);
...
void MtdsTest13() {
  ...
  */
  ...
  hbmpTest = mtds.CreateBitmap(40, 40, 16);
  if (hbmpTest == 0) {
    Serial.println("MtdsTest13: CreateBitmap failed");
  }
  mtds.SetDrawingSurface(hdsTest, hbmpTest);
...
void MtdsTest14() {
  ...
  */
  ...
  hbmpTest = mtds.CreateBitmap(40, 40, 16);
  if (hbmpTest == 0) {
    Serial.println("MtdsTest14: CreateBitmap failed");
  }
  mtds.SetDrawingSurface(hdsTest, hbmpTest);
...
void MtdsTest17() {
  ...
  */
  ...
  if (hbmpTest == 0) {
    Serial.println("MtdsTest17: CreateBitmap failed");
  }
  mtds.SetDrawingSurface(hdsTest, hbmpTest);
...
void MtdsTest18() {
  ...
  */
  ...
  hbmpTest = mtds.CreateBitmap(240, 320, 16);
  if (hbmpTest == 0) {
    Serial.println("MtdsTest18: CreateBitmap failed");
  }
  mtds.SetDrawingSurface(hdsTest, hbmpTest);
...
void MtdsTest24() {
  ...
  */
  ...
  hbmpTest = mtds.CreateBitmap(40, 40, 16);
  if (hbmpTest == 0) {
    Serial.println("MtdsTest24: CreateBitmap failed");
  }
  mtds.SetDrawingSurface(hdsTest, hbmpTest);
