...
proc create_root_design { parentCell } {
  ...
  set config_done [ create_bd_cell -type ip -vlnv user.org:user:config_done:1.0 config_done ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins config_done/S00_AXI]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces AXIM_read_xadc_0/MADC_AXI] [get_bd_addr_segs config_done/S00_AXI/S00_AXI_reg] -force
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs config_done/S00_AXI/S00_AXI_reg] -force
