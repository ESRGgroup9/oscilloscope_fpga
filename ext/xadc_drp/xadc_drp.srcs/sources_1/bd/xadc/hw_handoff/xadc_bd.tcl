...
################################################################
# This is a generated script based on design: xadc
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: read_xadc_0, and set properties
  set read_xadc_0 [ create_bd_cell -type ip -vlnv user.org:user:read_xadc:1.0 read_xadc_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins read_xadc_0/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net Vaux6n_1 [get_bd_ports Vaux6n] [get_bd_pins xadc_wiz_0/vauxn6]
  connect_bd_net -net Vaux6p_1 [get_bd_ports Vaux6p] [get_bd_pins xadc_wiz_0/vauxp6]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins read_xadc_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/dclk_in]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins read_xadc_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xadc_wiz_0_do_out [get_bd_pins ila_0/probe2] [get_bd_pins read_xadc_0/data_in] [get_bd_pins xadc_wiz_0/do_out]
  connect_bd_net -net xadc_wiz_0_drdy_out [get_bd_pins ila_0/probe1] [get_bd_pins read_xadc_0/eoc] [get_bd_pins xadc_wiz_0/drdy_out]
  connect_bd_net -net xadc_wiz_0_eoc_out [get_bd_pins ila_0/probe0] [get_bd_pins xadc_wiz_0/eoc_out]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xadc_wiz_0/dwe_in] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs read_xadc_0/S00_AXI/S00_AXI_reg] -force
