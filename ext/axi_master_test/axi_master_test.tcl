...
#
# Generated by Vivado on Wed Jun 01 23:30:13 WEST 2022
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/ip/my_master_1.0"] [file normalize "$origin_dir/src"] [file normalize "$origin_dir/ip/my_slave_1.0"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/bd/hdl/test_axi_i_wrapper.v"] \
]
add_files -norecurse -fileset $obj $files

# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/bd/test_axi_i.bd" ]\
]
