...
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { filt_select[1] }]; #IO_L24P_T3_34 Sch=sw[1]
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { filt_select[0] }]; #IO_L19N_T3_VREF_35 Sch=sw[0]

##HDMI TX
set_property -dict {PACKAGE_PIN H17 IOSTANDARD TMDS_33} [get_ports TMDSn_clk]
set_property -dict {PACKAGE_PIN H16 IOSTANDARD TMDS_33} [get_ports TMDSp_clk]
