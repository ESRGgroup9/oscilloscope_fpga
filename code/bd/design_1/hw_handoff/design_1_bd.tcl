...
proc create_root_design { parentCell } {
  ...
  set TMDSn_clk [ create_bd_port -dir O -type clk TMDSn_clk ]
  set TMDSp [ create_bd_port -dir O -from 2 -to 0 TMDSp ]
  set TMDSp_clk [ create_bd_port -dir O -type clk TMDSp_clk ]
  set filt_select [ create_bd_port -dir I -from 1 -to 0 filt_select ]
  ...
  set AXIM_read_xadc_0 [ create_bd_cell -type ip -vlnv user.org:user:AXIM_read_xadc:3 AXIM_read_xadc_0 ]
  set_property -dict [ list \
   CONFIG.DEBUG_PARAM {0} \
 ] $AXIM_read_xadc_0

  # Create instance: average_0, and set properties
  set average_0 [ create_bd_cell -type ip -vlnv user.org:user:average:1.0 average_0 ]
  ...
  # Create instance: configIP, and set properties
  set configIP [ create_bd_cell -type ip -vlnv user.org:user:configIP:1.0 configIP ]
  set_property -dict [ list \
   CONFIG.DEBUG_PARAM {0} \
 ] $configIP
  ...
  # Create instance: sampleIP_0, and set properties
  set sampleIP_0 [ create_bd_cell -type ip -vlnv user.org:user:sampleIP:1.0 sampleIP_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins configIP/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins debugIP/S00_AXI]
  ...
  connect_bd_net -net AXIM_read_xadc_0_eoc [get_bd_pins AXIM_read_xadc_0/eoc] [get_bd_pins debugIP/eoc]
  ...
  connect_bd_net -net sampleIP_0_sample [get_bd_pins average_0/start] [get_bd_pins filtersIP_0/start] [get_bd_pins sampleIP_0/sample]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces AXIM_read_xadc_0/MAXI_ADC] [get_bd_addr_segs configIP/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces AXIM_read_xadc_0/MAXI_ADC] [get_bd_addr_segs debugIP/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces AXIM_read_xadc_0/MAXI_ADC] [get_bd_addr_segs xadc_wiz_0/s_axi_lite/Reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs configIP/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs debugIP/S00_AXI/S00_AXI_reg] -force
