...
module hdmi_bd_hdmiIP_0_0(TMDSclk, pixclk, rst, TMDSp, TMDSn, TMDSp_clk, 
  TMDSn_clk)
/* synthesis syn_black_box black_box_pad_pin="TMDSclk,pixclk,rst,TMDSp[2:0],TMDSn[2:0],TMDSp_clk,TMDSn_clk" */;
  input TMDSclk;
  input pixclk;
  input rst;
  output [2:0]TMDSp;
