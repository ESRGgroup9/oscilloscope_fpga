...
#
# Generated by export_simulation on Thu Jun 02 00:57:46 WEST 2022
#
################################################################################
...
'-reset_run' switch to the './fir_filter_0.sh' script.

./fir_filter_0.sh -reset_run
...
./fir_filter_0.sh -noclean_files

For more information on the script, please type './fir_filter_0.sh -help'.
