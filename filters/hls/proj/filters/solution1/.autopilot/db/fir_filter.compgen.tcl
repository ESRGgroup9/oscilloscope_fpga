...
set ID 7
set hasByteEnable 0
set MemName fir_filter_mask_tbkb
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_ant \
    op interface \
    ports { x_ant_address0 { O 5 vector } x_ant_ce0 { O 1 bit } x_ant_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'x_ant'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_coefs \
    op interface \
    ports { x_coefs_address0 { O 5 vector } x_coefs_ce0 { O 1 bit } x_coefs_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'x_coefs'"
}
}
