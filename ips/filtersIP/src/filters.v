...
// M=22
// parameter M = (22 + 1);
// parameter XANT_ADDR_SIZE_BRAM 	= 5;
// parameter XANT_ADDR_SIZE 		= 5;
// parameter XCOEF_ADDR_SIZE_BRAM	= 7;
...
wire [XANT_ADDR_SIZE+1-1:0] xant_addr_ptr;
assign xant_addr_ptr = (xant_base_addr + filt_xant_addr);
...
// // update filter select only when there is no filter running
// always @(posedge clk) begin
//     if(~rstn) begin
//         filt_select_r <= 2'b11;
//     end
//     // else if(~is_state_main_S_FILTER) begin
//     else if(rbuf_writing) begin
//         filt_select_r <= filt_select;
//     end
// end
// ===========================================================================
// xant BRAM
...
bram_coefs xcoefs_bram (
    ...
    .dina({XCOEF_DATA_SIZE{1'b0}}), // input wire [31 : 0] dina
...
// `define XCOEF_ADDR_SIZE_BRAM 10
