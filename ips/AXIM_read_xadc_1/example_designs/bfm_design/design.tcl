proc create_ipi_design { offsetfile design_name } {
	...
	set MAXI_ADC_INIT_AXI_TXN [ create_bd_port -dir I MAXI_ADC_INIT_AXI_TXN ]
	set MAXI_ADC_ERROR [ create_bd_port -dir O MAXI_ADC_ERROR ]
	set MAXI_ADC_TXN_DONE [ create_bd_port -dir O MAXI_ADC_TXN_DONE ]
...
connect_bd_intf_net [get_bd_intf_pins slave_0/S_AXI ] [get_bd_intf_pins AXIM_read_xadc_0/MAXI_ADC]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins slave_0/ACLK] [get_bd_pins AXIM_read_xadc_0/MAXI_ADC_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins slave_0/ARESETN] [get_bd_pins AXIM_read_xadc_0/MAXI_ADC_ARESETN]
	connect_bd_net -net init_axi_txn_00 [get_bd_ports MAXI_ADC_INIT_AXI_TXN] [get_bd_pins AXIM_read_xadc_0/MAXI_ADC_INIT_AXI_TXN]
	connect_bd_net -net error_00 [get_bd_ports MAXI_ADC_ERROR] [get_bd_pins AXIM_read_xadc_0/MAXI_ADC_ERROR]
	connect_bd_net -net txn_done_00 [get_bd_ports MAXI_ADC_TXN_DONE] [get_bd_pins AXIM_read_xadc_0/MAXI_ADC_TXN_DONE]
...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/AXIM_read_xadc_v1_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef AXIM_read_xadc_v1_tb_include_vh_"
	puts $fp "`define AXIM_read_xadc_v1_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:AXIM_read_xadc:1]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/AXIM_read_xadc_v1_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AXIM_read_xadc_v1_bfm_${i}"
...
remove_files -quiet -fileset sim_1 AXIM_read_xadc_v1_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top AXIM_read_xadc_v1_tb [get_filesets sim_1]
