# Runtime Tcl commands to interact with - AXIM_read_xadc_v1

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/AXIM_read_xadc_v1_include.tcl
...
# Test: MAXI_ADC
set wdata_maxi_adc [get_init_data 0]
create_hw_axi_txn w_maxi_adc_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_maxi_adc}
create_hw_axi_txn r_maxi_adc_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_maxi_adc_addr
run_hw_axi w_maxi_adc_addr
run_hw_axi r_maxi_adc_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_maxi_adc_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - MAXI_ADC"
} else {
	puts "Data comparison test fail for - MAXI_ADC, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
